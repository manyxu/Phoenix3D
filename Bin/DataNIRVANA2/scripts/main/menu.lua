...
function n_CreateMainMenu()
	...
	PX2EU_MAN:Menu_Main_AddItem("Edit", "UnDo", PX2_LM:V("UnDo").."\tCtrl-Z", "n_UnDo()", "")
	PX2EU_MAN:Menu_Main_AddItem("Edit", "ReDo", PX2_LM:V("ReDo").."\tCtrl-R", "n_ReDo()", "")
	PX2EU_MAN:Menu_Main_AddItemSeparater("Edit")
	PX2EU_MAN:Menu_Main_AddItem("Edit", "Copy", PX2_LM:V("Copy").."\tCtrl-C", "n_Copy()", "")
	PX2EU_MAN:Menu_Main_AddItem("Edit", "Paste", PX2_LM:V("Paste").."\tCtrl-V", "n_Paste()", "")
	PX2EU_MAN:Menu_Main_AddItem("Edit", "Clone", PX2_LM:V("Clone").."\tCtrl-D", "n_Clone()", "")
	PX2EU_MAN:Menu_Main_AddItem("Edit", "Delete", PX2_LM:V("Delete").."\tDelete", "n_DeleteSelection()", "")
	PX2EU_MAN:Menu_Main_AddItemSeparater("Edit")
