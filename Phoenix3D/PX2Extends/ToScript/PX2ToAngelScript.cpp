...
static TexPackElement * fTexPackElement0()
{
	TexPackElement* pointer = new0 TexPackElement();
	return pointer;
}
static TexPack * fTexPack0()
{
	TexPack* pointer = new0 TexPack();
	return pointer;
}
...
static Actor * fActor0()
{
	Actor* pointer = new0 Actor();
	return pointer;
}
static CameraActor * fCameraActor0()
{
	CameraActor* pointer = new0 CameraActor();
	return pointer;
}
static TriggerActor * fTriggerActor0()
{
	TriggerActor* pointer = new0 TriggerActor();
	return pointer;
}
static BPFile * fBPFile0()
{
	BPFile* pointer = new0 BPFile();
	return pointer;
}
static BPModule * fBPModule0()
{
	BPModule* pointer = new0 BPModule();
	return pointer;
}
int toAS_PX2_open(asIScriptEngine* asEngine)
{
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectType("TexPackElement", 0,  asOBJ_REF | asOBJ_NOCOUNT);
	assert(r >= 0);
	r = asEngine->RegisterObjectType("TexPack", 0,  asOBJ_REF | asOBJ_NOCOUNT);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectType("EngineLoop", 0,  asOBJ_REF | asOBJ_NOCOUNT);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectType("Actor", 0, asOBJ_REF); 
	assert(r >= 0);
	r = asEngine->RegisterObjectType("CameraActor", 0, asOBJ_REF); 
	assert(r >= 0);
	r = asEngine->RegisterObjectType("TriggerActor", 0, asOBJ_REF); 
	assert(r >= 0);
	r = asEngine->RegisterObjectType("URDoManager", 0,  asOBJ_REF | asOBJ_NOCOUNT);
	assert(r >= 0);
	r = asEngine->RegisterObjectType("BPFile", 0, asOBJ_REF); 
	assert(r >= 0);
	r = asEngine->RegisterObjectType("BPModule", 0, asOBJ_REF); 
	assert(r >= 0);
	r = asEngine->RegisterObjectType("BPManager", 0,  asOBJ_REF | asOBJ_NOCOUNT);
	assert(r >= 0);
	r = asEngine->RegisterObjectType("ScriptHandler", 0,  asOBJ_REF | asOBJ_NOCOUNT);
	assert(r >= 0);
	r = asEngine->RegisterObjectType("General_EventHandler", 0,  asOBJ_REF | asOBJ_NOCOUNT);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Controlledable", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Controller", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveFloatController", "Controller@+ opImplCast()", asFUNCTION((RefCast<InterpCurveController, Controller>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveFloatController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveFloatController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveFloat3Controller", "Controller@+ opImplCast()", asFUNCTION((RefCast<InterpCurveController, Controller>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveFloat3Controller", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveFloat3Controller", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveUniformScaleController", "InterpCurveController@+ opImplCast()", asFUNCTION((RefCast<InterpCurveFloatController, InterpCurveController>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveUniformScaleController", "Controller@+ opImplCast()", asFUNCTION((RefCast<InterpCurveController, Controller>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveUniformScaleController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveUniformScaleController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveAlphaController", "InterpCurveController@+ opImplCast()", asFUNCTION((RefCast<InterpCurveFloatController, InterpCurveController>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveAlphaController", "Controller@+ opImplCast()", asFUNCTION((RefCast<InterpCurveController, Controller>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveAlphaController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveAlphaController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveScaleController", "InterpCurveController@+ opImplCast()", asFUNCTION((RefCast<InterpCurveFloat3Controller, InterpCurveController>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveScaleController", "Controller@+ opImplCast()", asFUNCTION((RefCast<InterpCurveController, Controller>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveScaleController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveScaleController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveRotateController", "InterpCurveController@+ opImplCast()", asFUNCTION((RefCast<InterpCurveFloat3Controller, InterpCurveController>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveRotateController", "Controller@+ opImplCast()", asFUNCTION((RefCast<InterpCurveController, Controller>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveRotateController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveRotateController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveTranslateController", "InterpCurveController@+ opImplCast()", asFUNCTION((RefCast<InterpCurveFloat3Controller, InterpCurveController>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveTranslateController", "Controller@+ opImplCast()", asFUNCTION((RefCast<InterpCurveController, Controller>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveTranslateController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveTranslateController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveColorController", "InterpCurveController@+ opImplCast()", asFUNCTION((RefCast<InterpCurveFloat3Controller, InterpCurveController>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveColorController", "Controller@+ opImplCast()", asFUNCTION((RefCast<InterpCurveController, Controller>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveColorController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("InterpCurveColorController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Buffer", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Texture", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Texture2D", "Object@+ opImplCast()", asFUNCTION((RefCast<Texture, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Texture2D", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Movable", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Movable", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("VertexFormat", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Renderable", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Renderable", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Renderable", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Triangles", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Triangles", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Triangles", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Triangles", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriMesh", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriMesh", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriMesh", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriMesh", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriMesh", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Node", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Node", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Node", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("SizeNode", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("SizeNode", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("SizeNode", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("SizeNode", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("SwitchNode", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("SwitchNode", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("SwitchNode", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("SwitchNode", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Camera", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Canvas", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	r = asEngine->RegisterObjectBehaviour("TexPackElement", asBEHAVE_FACTORY, "TexPackElement @ f()", asFUNCTION(fTexPackElement0), asCALL_CDECL);
	assert(r >= 0);
	...
	assert(r >= 0);
	// Class: TexPack
	r = asEngine->RegisterObjectBehaviour("TexPack", asBEHAVE_FACTORY, "TexPack @ f()", asFUNCTION(fTexPack0), asCALL_CDECL);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("LuaContext", "RefObject@+ opImplCast()", asFUNCTION((RefCast<ScriptContext, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ASContext", "RefObject@+ opImplCast()", asFUNCTION((RefCast<ScriptContext, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Effectable", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Effectable", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Effectable", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Effectable", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Effectable", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Effectable", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BeamEmitter", "TriMesh@+ opImplCast()", asFUNCTION((RefCast<Effectable, TriMesh>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BeamEmitter", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BeamEmitter", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BeamEmitter", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BeamEmitter", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BeamEmitter", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BeamEmitter", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Billboard", "TriMesh@+ opImplCast()", asFUNCTION((RefCast<Effectable, TriMesh>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Billboard", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Billboard", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Billboard", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Billboard", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Billboard", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Billboard", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraShake", "TriMesh@+ opImplCast()", asFUNCTION((RefCast<Effectable, TriMesh>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraShake", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraShake", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraShake", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraShake", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraShake", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraShake", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModel", "TriMesh@+ opImplCast()", asFUNCTION((RefCast<Effectable, TriMesh>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModel", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModel", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModel", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModel", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModel", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModel", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModelNode", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModelNode", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModelNode", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectModelNode", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ParticleEmitter", "TriMesh@+ opImplCast()", asFUNCTION((RefCast<Effectable, TriMesh>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ParticleEmitter", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ParticleEmitter", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ParticleEmitter", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ParticleEmitter", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ParticleEmitter", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ParticleEmitter", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("RibbonEmitter", "TriMesh@+ opImplCast()", asFUNCTION((RefCast<Effectable, TriMesh>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("RibbonEmitter", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("RibbonEmitter", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("RibbonEmitter", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("RibbonEmitter", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("RibbonEmitter", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("RibbonEmitter", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Soundable", "TriMesh@+ opImplCast()", asFUNCTION((RefCast<Effectable, TriMesh>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Soundable", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Soundable", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Soundable", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Soundable", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Soundable", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Soundable", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectableController", "Object@+ opImplCast()", asFUNCTION((RefCast<Controller, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("EffectableController", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFrame", "Node@+ opImplCast()", asFUNCTION((RefCast<SizeNode, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFrame", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFrame", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFrame", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFrame", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIPicBox", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIPicBox", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIPicBox", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIPicBox", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIPicBox", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIPicBox", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButtonBase", "SizeNode@+ opImplCast()", asFUNCTION((RefCast<UIFrame, SizeNode>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButtonBase", "Node@+ opImplCast()", asFUNCTION((RefCast<SizeNode, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButtonBase", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButtonBase", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButtonBase", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButtonBase", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButton", "UIFrame@+ opImplCast()", asFUNCTION((RefCast<UIButtonBase, UIFrame>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButton", "SizeNode@+ opImplCast()", asFUNCTION((RefCast<UIFrame, SizeNode>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButton", "Node@+ opImplCast()", asFUNCTION((RefCast<SizeNode, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButton", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButton", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButton", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIButton", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFPicBox", "SizeNode@+ opImplCast()", asFUNCTION((RefCast<UIFrame, SizeNode>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFPicBox", "Node@+ opImplCast()", asFUNCTION((RefCast<SizeNode, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFPicBox", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFPicBox", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFPicBox", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFPicBox", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIText", "Triangles@+ opImplCast()", asFUNCTION((RefCast<TriMesh, Triangles>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIText", "Renderable@+ opImplCast()", asFUNCTION((RefCast<Triangles, Renderable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIText", "Movable@+ opImplCast()", asFUNCTION((RefCast<Renderable, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIText", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIText", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIText", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFText", "SizeNode@+ opImplCast()", asFUNCTION((RefCast<UIFrame, SizeNode>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFText", "Node@+ opImplCast()", asFUNCTION((RefCast<SizeNode, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFText", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFText", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFText", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UIFText", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UICanvas", "Object@+ opImplCast()", asFUNCTION((RefCast<Canvas, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("UICanvas", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Project", "UICanvas @+ GetUICanvas()", asMETHODPR(Project, GetUICanvas, (), UICanvas * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Project", "void SetSize(float width, float height)", asMETHODPR(Project, SetSize, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Project", "void SetSize(const Sizef & size)", asMETHODPR(Project, SetSize, (const Sizef & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Project", "const Sizef & GetSize() const", asMETHODPR(Project, GetSize, () const, const Sizef & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Project", "float GetWidth() const", asMETHODPR(Project, GetWidth, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Project", "float GetHeight() const", asMETHODPR(Project, GetHeight, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	// Class: EngineLoop
	// Class: Selection
	// Class: Creater
	r = asEngine->RegisterObjectMethod("Creater", "Actor @+ CreateActor_Rectangle(Node @+ parent, const APoint & pos, bool posIsLocal)", asMETHODPR(Creater, CreateActor_Rectangle, (Node * , const APoint & , bool), Actor * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Creater", "Actor @+ CreateActor_Box(Node @+ parent, const APoint & pos, bool posIsLocal)", asMETHODPR(Creater, CreateActor_Box, (Node * , const APoint & , bool), Actor * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Creater", "Actor @+ CreateActor_Sphere(Node @+ parent, const APoint & pos, bool posIsLocal)", asMETHODPR(Creater, CreateActor_Sphere, (Node * , const APoint & , bool), Actor * ), asCALL_THISCALL);
	assert(r >= 0);
	// Class: Scene
	...
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Scene", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Scene", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Scene", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Scene", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	...
	assert(r >= 0);
	// Class: Actor
	r = asEngine->RegisterObjectBehaviour("Actor", asBEHAVE_FACTORY, "Actor @+ f()", asFUNCTION(fActor0), asCALL_CDECL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("Actor", asBEHAVE_ADDREF, "void f()", asMETHOD(Actor, IncrementReferences), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("Actor", asBEHAVE_RELEASE, "void f()", asMETHOD(Actor, DecrementReferences), asCALL_THISCALL); 
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Node@+ opImplCast()", asFUNCTION((RefCast<Actor, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void IncrementReferences()", asMETHODPR(Actor, IncrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void DecrementReferences()", asMETHODPR(Actor, DecrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int GetReferences() const", asMETHODPR(Actor, GetReferences, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void Enable(bool enable)", asMETHODPR(Actor, Enable, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsEnable() const", asMETHODPR(Actor, IsEnable, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetActivate(bool act)", asMETHODPR(Actor, SetActivate, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsActivated() const", asMETHODPR(Actor, IsActivated, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "const Rtti & GetRttiType() const", asMETHODPR(Actor, GetRttiType, () const, const Rtti & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "uint16 GetRttiVersion() const", asMETHODPR(Actor, GetRttiVersion, () const, unsigned short), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsExactly(const Rtti & type) const", asMETHODPR(Actor, IsExactly, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsDerived(const Rtti & type) const", asMETHODPR(Actor, IsDerived, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsExactlyTypeOf(const Object @+ object) const", asMETHODPR(Actor, IsExactlyTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsDerivedTypeOf(const Object @+ object) const", asMETHODPR(Actor, IsDerivedTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetUserDataFloat(const string & name, float val)", asMETHODPR(Actor, SetUserDataFloat, (const std::string & , float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "float GetUserDataFloat(const string & name, bool & isValied) const", asMETHODPR(Actor, GetUserDataFloat, (const std::string & , bool * ) const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "const string & GetResourcePath() const", asMETHODPR(Actor, GetResourcePath, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetName(const string & name)", asMETHODPR(Actor, SetName, (const std::string & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "const string & GetName() const", asMETHODPR(Actor, GetName, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Object @+ GetObjectByName(const string & name)", asMETHODPR(Actor, GetObjectByName, (const std::string & ), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetID(int id)", asMETHODPR(Actor, SetID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int GetID() const", asMETHODPR(Actor, GetID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Object @+ GetObjectByID(int id)", asMETHODPR(Actor, GetObjectByID, (int), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void ComeInEventWorld()", asMETHODPR(Actor, ComeInEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void GoOutEventWorld()", asMETHODPR(Actor, GoOutEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsInEventWorld()", asMETHODPR(Actor, IsInEventWorld, (), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void ResetPlay()", asMETHODPR(Actor, ResetPlay, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void Play()", asMETHODPR(Actor, Play, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsPlaying() const", asMETHODPR(Actor, IsPlaying, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void Stop()", asMETHODPR(Actor, Stop, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void Reset()", asMETHODPR(Actor, Reset, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetSelfCtrled(bool selfCtrled)", asMETHODPR(Actor, SetSelfCtrled, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsSelfCtrled() const", asMETHODPR(Actor, IsSelfCtrled, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetAutoPlay(bool autoPlay)", asMETHODPR(Actor, SetAutoPlay, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsAutoPlay() const", asMETHODPR(Actor, IsAutoPlay, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int GetNumControllers() const", asMETHODPR(Actor, GetNumControllers, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Controller @+ GetController(int i) const", asMETHODPR(Actor, GetController, (int) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Controller @+ GetControllerByName(const string & name) const", asMETHODPR(Actor, GetControllerByName, (const std::string & ) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool HasController(Controller @+ controller)", asMETHODPR(Actor, HasController, (Controller * ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void AttachController(Controller @+ controller)", asMETHODPR(Actor, AttachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void DetachController(Controller @+ controller)", asMETHODPR(Actor, DetachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void DetachAllControllers()", asMETHODPR(Actor, DetachAllControllers, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SortControls()", asMETHODPR(Actor, SortControls, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool UpdateControllers(double applicationTime, double elapsedTime)", asMETHODPR(Actor, UpdateControllers, (double, double), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void Show(bool show)", asMETHODPR(Actor, Show, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsShow() const", asMETHODPR(Actor, IsShow, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "Movable @+ GetParent()", asMETHODPR(Actor, GetParent, (), Movable * ), asCALL_THISCALL);
	assert(r >= 0);
					r = asEngine->RegisterObjectMethod("Actor", "int GetNumChildren() const", asMETHODPR(Actor, GetNumChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int GetNumValidChildren() const", asMETHODPR(Actor, GetNumValidChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int AttachChild(Movable @+ child)", asMETHODPR(Actor, AttachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void InsertChild(Movable @+ before, Movable @+ child)", asMETHODPR(Actor, InsertChild, (Movable * , Movable * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int DetachChild(Movable @+ child)", asMETHODPR(Actor, DetachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool DetachChildByName(const string & name)", asMETHODPR(Actor, DetachChildByName, (const std::string & ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void DetachAllChildren()", asMETHODPR(Actor, DetachAllChildren, (), void), asCALL_THISCALL);
	assert(r >= 0);
		r = asEngine->RegisterObjectMethod("Actor", "void SetAlpha(float alpha)", asMETHODPR(Actor, SetAlpha, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetColor(const Float3 & color)", asMETHODPR(Actor, SetColor, (const Float3 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetBrightness(float brightness)", asMETHODPR(Actor, SetBrightness, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetCastShadow(bool castShadow)", asMETHODPR(Actor, SetCastShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetReceiveShadow(bool reciveShadow)", asMETHODPR(Actor, SetReceiveShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetDoPickPriority(bool doPickPriority)", asMETHODPR(Actor, SetDoPickPriority, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsDoPickPriority() const", asMETHODPR(Actor, IsDoPickPriority, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void OnNotPicked(int pickInfo)", asMETHODPR(Actor, OnNotPicked, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetNeedCalUpdateChild(bool needCal)", asMETHODPR(Actor, SetNeedCalUpdateChild, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "bool IsNeedCalUpdateChild() const", asMETHODPR(Actor, IsNeedCalUpdateChild, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetAnchorID(int anchorID)", asMETHODPR(Actor, SetAnchorID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int GetAnchorID() const", asMETHODPR(Actor, GetAnchorID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetTypeID(int typeID)", asMETHODPR(Actor, SetTypeID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int GetTypeID() const", asMETHODPR(Actor, GetTypeID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "void SetGroup(int group)", asMETHODPR(Actor, SetGroup, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("Actor", "int GetGroup() const", asMETHODPR(Actor, GetGroup, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	// Class: CameraActor
	r = asEngine->RegisterObjectBehaviour("CameraActor", asBEHAVE_FACTORY, "CameraActor @+ f()", asFUNCTION(fCameraActor0), asCALL_CDECL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("CameraActor", asBEHAVE_ADDREF, "void f()", asMETHOD(CameraActor, IncrementReferences), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("CameraActor", asBEHAVE_RELEASE, "void f()", asMETHOD(CameraActor, DecrementReferences), asCALL_THISCALL); 
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Actor@+ opImplCast()", asFUNCTION((RefCast<CameraActor, Actor>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Node@+ opImplCast()", asFUNCTION((RefCast<Actor, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void IncrementReferences()", asMETHODPR(CameraActor, IncrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void DecrementReferences()", asMETHODPR(CameraActor, DecrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int GetReferences() const", asMETHODPR(CameraActor, GetReferences, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void Enable(bool enable)", asMETHODPR(CameraActor, Enable, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsEnable() const", asMETHODPR(CameraActor, IsEnable, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetActivate(bool act)", asMETHODPR(CameraActor, SetActivate, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsActivated() const", asMETHODPR(CameraActor, IsActivated, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "const Rtti & GetRttiType() const", asMETHODPR(CameraActor, GetRttiType, () const, const Rtti & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "uint16 GetRttiVersion() const", asMETHODPR(CameraActor, GetRttiVersion, () const, unsigned short), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsExactly(const Rtti & type) const", asMETHODPR(CameraActor, IsExactly, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsDerived(const Rtti & type) const", asMETHODPR(CameraActor, IsDerived, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsExactlyTypeOf(const Object @+ object) const", asMETHODPR(CameraActor, IsExactlyTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsDerivedTypeOf(const Object @+ object) const", asMETHODPR(CameraActor, IsDerivedTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetUserDataFloat(const string & name, float val)", asMETHODPR(CameraActor, SetUserDataFloat, (const std::string & , float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "float GetUserDataFloat(const string & name, bool & isValied) const", asMETHODPR(CameraActor, GetUserDataFloat, (const std::string & , bool * ) const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "const string & GetResourcePath() const", asMETHODPR(CameraActor, GetResourcePath, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetName(const string & name)", asMETHODPR(CameraActor, SetName, (const std::string & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "const string & GetName() const", asMETHODPR(CameraActor, GetName, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Object @+ GetObjectByName(const string & name)", asMETHODPR(CameraActor, GetObjectByName, (const std::string & ), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetID(int id)", asMETHODPR(CameraActor, SetID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int GetID() const", asMETHODPR(CameraActor, GetID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Object @+ GetObjectByID(int id)", asMETHODPR(CameraActor, GetObjectByID, (int), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void ComeInEventWorld()", asMETHODPR(CameraActor, ComeInEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void GoOutEventWorld()", asMETHODPR(CameraActor, GoOutEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsInEventWorld()", asMETHODPR(CameraActor, IsInEventWorld, (), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void ResetPlay()", asMETHODPR(CameraActor, ResetPlay, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void Play()", asMETHODPR(CameraActor, Play, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsPlaying() const", asMETHODPR(CameraActor, IsPlaying, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void Stop()", asMETHODPR(CameraActor, Stop, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void Reset()", asMETHODPR(CameraActor, Reset, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetSelfCtrled(bool selfCtrled)", asMETHODPR(CameraActor, SetSelfCtrled, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsSelfCtrled() const", asMETHODPR(CameraActor, IsSelfCtrled, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetAutoPlay(bool autoPlay)", asMETHODPR(CameraActor, SetAutoPlay, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsAutoPlay() const", asMETHODPR(CameraActor, IsAutoPlay, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int GetNumControllers() const", asMETHODPR(CameraActor, GetNumControllers, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Controller @+ GetController(int i) const", asMETHODPR(CameraActor, GetController, (int) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Controller @+ GetControllerByName(const string & name) const", asMETHODPR(CameraActor, GetControllerByName, (const std::string & ) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool HasController(Controller @+ controller)", asMETHODPR(CameraActor, HasController, (Controller * ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void AttachController(Controller @+ controller)", asMETHODPR(CameraActor, AttachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void DetachController(Controller @+ controller)", asMETHODPR(CameraActor, DetachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void DetachAllControllers()", asMETHODPR(CameraActor, DetachAllControllers, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SortControls()", asMETHODPR(CameraActor, SortControls, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool UpdateControllers(double applicationTime, double elapsedTime)", asMETHODPR(CameraActor, UpdateControllers, (double, double), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void Show(bool show)", asMETHODPR(CameraActor, Show, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsShow() const", asMETHODPR(CameraActor, IsShow, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Movable @+ GetParent()", asMETHODPR(CameraActor, GetParent, (), Movable * ), asCALL_THISCALL);
	assert(r >= 0);
					r = asEngine->RegisterObjectMethod("CameraActor", "int GetNumChildren() const", asMETHODPR(CameraActor, GetNumChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int GetNumValidChildren() const", asMETHODPR(CameraActor, GetNumValidChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int AttachChild(Movable @+ child)", asMETHODPR(CameraActor, AttachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void InsertChild(Movable @+ before, Movable @+ child)", asMETHODPR(CameraActor, InsertChild, (Movable * , Movable * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int DetachChild(Movable @+ child)", asMETHODPR(CameraActor, DetachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool DetachChildByName(const string & name)", asMETHODPR(CameraActor, DetachChildByName, (const std::string & ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void DetachAllChildren()", asMETHODPR(CameraActor, DetachAllChildren, (), void), asCALL_THISCALL);
	assert(r >= 0);
		r = asEngine->RegisterObjectMethod("CameraActor", "void SetAlpha(float alpha)", asMETHODPR(CameraActor, SetAlpha, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetColor(const Float3 & color)", asMETHODPR(CameraActor, SetColor, (const Float3 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetBrightness(float brightness)", asMETHODPR(CameraActor, SetBrightness, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetCastShadow(bool castShadow)", asMETHODPR(CameraActor, SetCastShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetReceiveShadow(bool reciveShadow)", asMETHODPR(CameraActor, SetReceiveShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetDoPickPriority(bool doPickPriority)", asMETHODPR(CameraActor, SetDoPickPriority, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsDoPickPriority() const", asMETHODPR(CameraActor, IsDoPickPriority, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void OnNotPicked(int pickInfo)", asMETHODPR(CameraActor, OnNotPicked, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetNeedCalUpdateChild(bool needCal)", asMETHODPR(CameraActor, SetNeedCalUpdateChild, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "bool IsNeedCalUpdateChild() const", asMETHODPR(CameraActor, IsNeedCalUpdateChild, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetAnchorID(int anchorID)", asMETHODPR(CameraActor, SetAnchorID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int GetAnchorID() const", asMETHODPR(CameraActor, GetAnchorID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetTypeID(int typeID)", asMETHODPR(CameraActor, SetTypeID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int GetTypeID() const", asMETHODPR(CameraActor, GetTypeID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetGroup(int group)", asMETHODPR(CameraActor, SetGroup, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "int GetGroup() const", asMETHODPR(CameraActor, GetGroup, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void SetFOV(float fov)", asMETHODPR(CameraActor, SetFOV, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "float GetFOV() const", asMETHODPR(CameraActor, GetFOV, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void LookAt(const APoint & pos)", asMETHODPR(CameraActor, LookAt, (const APoint & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "void LookAt(const Movable @+ mov)", asMETHODPR(CameraActor, LookAt, (const Movable * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("CameraActor", "Camera @+ GetCamera()", asMETHODPR(CameraActor, GetCamera, (), Camera * ), asCALL_THISCALL);
	assert(r >= 0);
	// Class: TriggerActor
	r = asEngine->RegisterObjectBehaviour("TriggerActor", asBEHAVE_FACTORY, "TriggerActor @+ f()", asFUNCTION(fTriggerActor0), asCALL_CDECL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("TriggerActor", asBEHAVE_ADDREF, "void f()", asMETHOD(TriggerActor, IncrementReferences), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("TriggerActor", asBEHAVE_RELEASE, "void f()", asMETHOD(TriggerActor, DecrementReferences), asCALL_THISCALL); 
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Actor@+ opImplCast()", asFUNCTION((RefCast<TriggerActor, Actor>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Node@+ opImplCast()", asFUNCTION((RefCast<Actor, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void IncrementReferences()", asMETHODPR(TriggerActor, IncrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void DecrementReferences()", asMETHODPR(TriggerActor, DecrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int GetReferences() const", asMETHODPR(TriggerActor, GetReferences, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void Enable(bool enable)", asMETHODPR(TriggerActor, Enable, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsEnable() const", asMETHODPR(TriggerActor, IsEnable, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetActivate(bool act)", asMETHODPR(TriggerActor, SetActivate, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsActivated() const", asMETHODPR(TriggerActor, IsActivated, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "const Rtti & GetRttiType() const", asMETHODPR(TriggerActor, GetRttiType, () const, const Rtti & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "uint16 GetRttiVersion() const", asMETHODPR(TriggerActor, GetRttiVersion, () const, unsigned short), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsExactly(const Rtti & type) const", asMETHODPR(TriggerActor, IsExactly, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsDerived(const Rtti & type) const", asMETHODPR(TriggerActor, IsDerived, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsExactlyTypeOf(const Object @+ object) const", asMETHODPR(TriggerActor, IsExactlyTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsDerivedTypeOf(const Object @+ object) const", asMETHODPR(TriggerActor, IsDerivedTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetUserDataFloat(const string & name, float val)", asMETHODPR(TriggerActor, SetUserDataFloat, (const std::string & , float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "float GetUserDataFloat(const string & name, bool & isValied) const", asMETHODPR(TriggerActor, GetUserDataFloat, (const std::string & , bool * ) const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "const string & GetResourcePath() const", asMETHODPR(TriggerActor, GetResourcePath, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetName(const string & name)", asMETHODPR(TriggerActor, SetName, (const std::string & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "const string & GetName() const", asMETHODPR(TriggerActor, GetName, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Object @+ GetObjectByName(const string & name)", asMETHODPR(TriggerActor, GetObjectByName, (const std::string & ), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetID(int id)", asMETHODPR(TriggerActor, SetID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int GetID() const", asMETHODPR(TriggerActor, GetID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Object @+ GetObjectByID(int id)", asMETHODPR(TriggerActor, GetObjectByID, (int), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void ComeInEventWorld()", asMETHODPR(TriggerActor, ComeInEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void GoOutEventWorld()", asMETHODPR(TriggerActor, GoOutEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsInEventWorld()", asMETHODPR(TriggerActor, IsInEventWorld, (), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void ResetPlay()", asMETHODPR(TriggerActor, ResetPlay, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void Play()", asMETHODPR(TriggerActor, Play, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsPlaying() const", asMETHODPR(TriggerActor, IsPlaying, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void Stop()", asMETHODPR(TriggerActor, Stop, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void Reset()", asMETHODPR(TriggerActor, Reset, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetSelfCtrled(bool selfCtrled)", asMETHODPR(TriggerActor, SetSelfCtrled, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsSelfCtrled() const", asMETHODPR(TriggerActor, IsSelfCtrled, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetAutoPlay(bool autoPlay)", asMETHODPR(TriggerActor, SetAutoPlay, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsAutoPlay() const", asMETHODPR(TriggerActor, IsAutoPlay, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int GetNumControllers() const", asMETHODPR(TriggerActor, GetNumControllers, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Controller @+ GetController(int i) const", asMETHODPR(TriggerActor, GetController, (int) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Controller @+ GetControllerByName(const string & name) const", asMETHODPR(TriggerActor, GetControllerByName, (const std::string & ) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool HasController(Controller @+ controller)", asMETHODPR(TriggerActor, HasController, (Controller * ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void AttachController(Controller @+ controller)", asMETHODPR(TriggerActor, AttachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void DetachController(Controller @+ controller)", asMETHODPR(TriggerActor, DetachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void DetachAllControllers()", asMETHODPR(TriggerActor, DetachAllControllers, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SortControls()", asMETHODPR(TriggerActor, SortControls, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool UpdateControllers(double applicationTime, double elapsedTime)", asMETHODPR(TriggerActor, UpdateControllers, (double, double), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void Show(bool show)", asMETHODPR(TriggerActor, Show, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsShow() const", asMETHODPR(TriggerActor, IsShow, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "Movable @+ GetParent()", asMETHODPR(TriggerActor, GetParent, (), Movable * ), asCALL_THISCALL);
	assert(r >= 0);
					r = asEngine->RegisterObjectMethod("TriggerActor", "int GetNumChildren() const", asMETHODPR(TriggerActor, GetNumChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int GetNumValidChildren() const", asMETHODPR(TriggerActor, GetNumValidChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int AttachChild(Movable @+ child)", asMETHODPR(TriggerActor, AttachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void InsertChild(Movable @+ before, Movable @+ child)", asMETHODPR(TriggerActor, InsertChild, (Movable * , Movable * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int DetachChild(Movable @+ child)", asMETHODPR(TriggerActor, DetachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool DetachChildByName(const string & name)", asMETHODPR(TriggerActor, DetachChildByName, (const std::string & ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void DetachAllChildren()", asMETHODPR(TriggerActor, DetachAllChildren, (), void), asCALL_THISCALL);
	assert(r >= 0);
		r = asEngine->RegisterObjectMethod("TriggerActor", "void SetAlpha(float alpha)", asMETHODPR(TriggerActor, SetAlpha, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetColor(const Float3 & color)", asMETHODPR(TriggerActor, SetColor, (const Float3 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetBrightness(float brightness)", asMETHODPR(TriggerActor, SetBrightness, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetCastShadow(bool castShadow)", asMETHODPR(TriggerActor, SetCastShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetReceiveShadow(bool reciveShadow)", asMETHODPR(TriggerActor, SetReceiveShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetDoPickPriority(bool doPickPriority)", asMETHODPR(TriggerActor, SetDoPickPriority, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsDoPickPriority() const", asMETHODPR(TriggerActor, IsDoPickPriority, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void OnNotPicked(int pickInfo)", asMETHODPR(TriggerActor, OnNotPicked, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetNeedCalUpdateChild(bool needCal)", asMETHODPR(TriggerActor, SetNeedCalUpdateChild, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "bool IsNeedCalUpdateChild() const", asMETHODPR(TriggerActor, IsNeedCalUpdateChild, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetAnchorID(int anchorID)", asMETHODPR(TriggerActor, SetAnchorID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int GetAnchorID() const", asMETHODPR(TriggerActor, GetAnchorID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetTypeID(int typeID)", asMETHODPR(TriggerActor, SetTypeID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int GetTypeID() const", asMETHODPR(TriggerActor, GetTypeID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "void SetGroup(int group)", asMETHODPR(TriggerActor, SetGroup, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("TriggerActor", "int GetGroup() const", asMETHODPR(TriggerActor, GetGroup, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	// Class: URDoManager
	r = asEngine->RegisterObjectMethod("URDoManager", "void Clear()", asMETHODPR(URDoManager, Clear, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("URDoManager", "bool IsHasUnDo() const", asMETHODPR(URDoManager, IsHasUnDo, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("URDoManager", "bool IsHasReDo() const", asMETHODPR(URDoManager, IsHasReDo, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("URDoManager", "void UnDo()", asMETHODPR(URDoManager, UnDo, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("URDoManager", "void ReDo()", asMETHODPR(URDoManager, ReDo, (), void), asCALL_THISCALL);
	assert(r >= 0);
	// Class: BPFile
	r = asEngine->RegisterObjectBehaviour("BPFile", asBEHAVE_FACTORY, "BPFile @+ f()", asFUNCTION(fBPFile0), asCALL_CDECL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("BPFile", asBEHAVE_ADDREF, "void f()", asMETHOD(BPFile, IncrementReferences), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("BPFile", asBEHAVE_RELEASE, "void f()", asMETHOD(BPFile, DecrementReferences), asCALL_THISCALL); 
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "UIFrame@+ opImplCast()", asFUNCTION((RefCast<BPFile, UIFrame>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "SizeNode@+ opImplCast()", asFUNCTION((RefCast<UIFrame, SizeNode>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Node@+ opImplCast()", asFUNCTION((RefCast<SizeNode, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void IncrementReferences()", asMETHODPR(BPFile, IncrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void DecrementReferences()", asMETHODPR(BPFile, DecrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "int GetReferences() const", asMETHODPR(BPFile, GetReferences, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void Enable(bool enable)", asMETHODPR(BPFile, Enable, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsEnable() const", asMETHODPR(BPFile, IsEnable, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetActivate(bool act)", asMETHODPR(BPFile, SetActivate, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsActivated() const", asMETHODPR(BPFile, IsActivated, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const Rtti & GetRttiType() const", asMETHODPR(BPFile, GetRttiType, () const, const Rtti & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "uint16 GetRttiVersion() const", asMETHODPR(BPFile, GetRttiVersion, () const, unsigned short), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsExactly(const Rtti & type) const", asMETHODPR(BPFile, IsExactly, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsDerived(const Rtti & type) const", asMETHODPR(BPFile, IsDerived, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsExactlyTypeOf(const Object @+ object) const", asMETHODPR(BPFile, IsExactlyTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsDerivedTypeOf(const Object @+ object) const", asMETHODPR(BPFile, IsDerivedTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetUserDataFloat(const string & name, float val)", asMETHODPR(BPFile, SetUserDataFloat, (const std::string & , float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "float GetUserDataFloat(const string & name, bool & isValied) const", asMETHODPR(BPFile, GetUserDataFloat, (const std::string & , bool * ) const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const string & GetResourcePath() const", asMETHODPR(BPFile, GetResourcePath, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetName(const string & name)", asMETHODPR(BPFile, SetName, (const std::string & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const string & GetName() const", asMETHODPR(BPFile, GetName, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Object @+ GetObjectByName(const string & name)", asMETHODPR(BPFile, GetObjectByName, (const std::string & ), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetID(int id)", asMETHODPR(BPFile, SetID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "int GetID() const", asMETHODPR(BPFile, GetID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Object @+ GetObjectByID(int id)", asMETHODPR(BPFile, GetObjectByID, (int), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void ComeInEventWorld()", asMETHODPR(BPFile, ComeInEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void GoOutEventWorld()", asMETHODPR(BPFile, GoOutEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsInEventWorld()", asMETHODPR(BPFile, IsInEventWorld, (), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void ResetPlay()", asMETHODPR(BPFile, ResetPlay, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void Play()", asMETHODPR(BPFile, Play, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsPlaying() const", asMETHODPR(BPFile, IsPlaying, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void Stop()", asMETHODPR(BPFile, Stop, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void Reset()", asMETHODPR(BPFile, Reset, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetSelfCtrled(bool selfCtrled)", asMETHODPR(BPFile, SetSelfCtrled, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsSelfCtrled() const", asMETHODPR(BPFile, IsSelfCtrled, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAutoPlay(bool autoPlay)", asMETHODPR(BPFile, SetAutoPlay, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsAutoPlay() const", asMETHODPR(BPFile, IsAutoPlay, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "int GetNumControllers() const", asMETHODPR(BPFile, GetNumControllers, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Controller @+ GetController(int i) const", asMETHODPR(BPFile, GetController, (int) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Controller @+ GetControllerByName(const string & name) const", asMETHODPR(BPFile, GetControllerByName, (const std::string & ) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool HasController(Controller @+ controller)", asMETHODPR(BPFile, HasController, (Controller * ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void AttachController(Controller @+ controller)", asMETHODPR(BPFile, AttachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void DetachController(Controller @+ controller)", asMETHODPR(BPFile, DetachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void DetachAllControllers()", asMETHODPR(BPFile, DetachAllControllers, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SortControls()", asMETHODPR(BPFile, SortControls, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool UpdateControllers(double applicationTime, double elapsedTime)", asMETHODPR(BPFile, UpdateControllers, (double, double), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void Show(bool show)", asMETHODPR(BPFile, Show, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsShow() const", asMETHODPR(BPFile, IsShow, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "Movable @+ GetParent()", asMETHODPR(BPFile, GetParent, (), Movable * ), asCALL_THISCALL);
	assert(r >= 0);
					r = asEngine->RegisterObjectMethod("BPFile", "int GetNumChildren() const", asMETHODPR(BPFile, GetNumChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "int GetNumValidChildren() const", asMETHODPR(BPFile, GetNumValidChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "int AttachChild(Movable @+ child)", asMETHODPR(BPFile, AttachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void InsertChild(Movable @+ before, Movable @+ child)", asMETHODPR(BPFile, InsertChild, (Movable * , Movable * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "int DetachChild(Movable @+ child)", asMETHODPR(BPFile, DetachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool DetachChildByName(const string & name)", asMETHODPR(BPFile, DetachChildByName, (const std::string & ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void DetachAllChildren()", asMETHODPR(BPFile, DetachAllChildren, (), void), asCALL_THISCALL);
	assert(r >= 0);
		r = asEngine->RegisterObjectMethod("BPFile", "void SetAlpha(float alpha)", asMETHODPR(BPFile, SetAlpha, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetColor(const Float3 & color)", asMETHODPR(BPFile, SetColor, (const Float3 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetBrightness(float brightness)", asMETHODPR(BPFile, SetBrightness, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetCastShadow(bool castShadow)", asMETHODPR(BPFile, SetCastShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetReceiveShadow(bool reciveShadow)", asMETHODPR(BPFile, SetReceiveShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetDoPickPriority(bool doPickPriority)", asMETHODPR(BPFile, SetDoPickPriority, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsDoPickPriority() const", asMETHODPR(BPFile, IsDoPickPriority, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void OnNotPicked(int pickInfo)", asMETHODPR(BPFile, OnNotPicked, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetNeedCalUpdateChild(bool needCal)", asMETHODPR(BPFile, SetNeedCalUpdateChild, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsNeedCalUpdateChild() const", asMETHODPR(BPFile, IsNeedCalUpdateChild, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorID(int anchorID)", asMETHODPR(BPFile, SetAnchorID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "int GetAnchorID() const", asMETHODPR(BPFile, GetAnchorID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetSize(float width, float height)", asMETHODPR(BPFile, SetSize, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetSize(const Sizef & size)", asMETHODPR(BPFile, SetSize, (const Sizef & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const Sizef & GetSize() const", asMETHODPR(BPFile, GetSize, () const, const Sizef & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetWidth(float width)", asMETHODPR(BPFile, SetWidth, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "float GetWidth() const", asMETHODPR(BPFile, GetWidth, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetHeight(float height)", asMETHODPR(BPFile, SetHeight, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "float GetHeight() const", asMETHODPR(BPFile, GetHeight, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetPivot(float x, float y)", asMETHODPR(BPFile, SetPivot, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetPivot(const Float2 & pvoit)", asMETHODPR(BPFile, SetPivot, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const Float2 & GetPvoit() const", asMETHODPR(BPFile, GetPvoit, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void EnableAnchorLayout(bool enable)", asMETHODPR(BPFile, EnableAnchorLayout, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsAnchorLayoutEnable() const", asMETHODPR(BPFile, IsAnchorLayoutEnable, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorHor(float anchorX, float anchorY)", asMETHODPR(BPFile, SetAnchorHor, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorHor(const Float2 & anchor)", asMETHODPR(BPFile, SetAnchorHor, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const Float2 & GetAnchorHor() const", asMETHODPR(BPFile, GetAnchorHor, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorParamHor(float param0, float param1)", asMETHODPR(BPFile, SetAnchorParamHor, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorParamHor(const Float2 & param)", asMETHODPR(BPFile, SetAnchorParamHor, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const Float2 & GetAnchorParamHor() const", asMETHODPR(BPFile, GetAnchorParamHor, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorVer(float anchorX, float anchorY)", asMETHODPR(BPFile, SetAnchorVer, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorVer(const Float2 & anchor)", asMETHODPR(BPFile, SetAnchorVer, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const Float2 & GetAnchorVer() const", asMETHODPR(BPFile, GetAnchorVer, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorParamVer(float param0, float param1)", asMETHODPR(BPFile, SetAnchorParamVer, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetAnchorParamVer(const Float2 & param)", asMETHODPR(BPFile, SetAnchorParamVer, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const Float2 & GetAnchorParamVer() const", asMETHODPR(BPFile, GetAnchorParamVer, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "UICanvas @+ GetBelongUICanvas()", asMETHODPR(BPFile, GetBelongUICanvas, (), UICanvas * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "UIPicBox @+ CreateAddBackgroundPicBox(bool setWhite)", asMETHODPR(BPFile, CreateAddBackgroundPicBox, (bool), UIPicBox * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "UIPicBox @+ GetBackgroundPicBox()", asMETHODPR(BPFile, GetBackgroundPicBox, (), UIPicBox * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void DestoryBackgroundPicBox()", asMETHODPR(BPFile, DestoryBackgroundPicBox, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetActivateColor(const Float3 & color)", asMETHODPR(BPFile, SetActivateColor, (const Float3 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "const Float3 & GetActivateColor() const", asMETHODPR(BPFile, GetActivateColor, () const, const Float3 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetActivateAlpha(float alpha)", asMETHODPR(BPFile, SetActivateAlpha, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "float GetActivateAlpha() const", asMETHODPR(BPFile, GetActivateAlpha, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetActivateBrightness(float brightness)", asMETHODPR(BPFile, SetActivateBrightness, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "float GetActivateBrightness() const", asMETHODPR(BPFile, GetActivateBrightness, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetUIChildPickOnlyInSizeRange(bool onlyInRange)", asMETHODPR(BPFile, SetUIChildPickOnlyInSizeRange, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "bool IsUIChildPickOnlyInSizeRange() const", asMETHODPR(BPFile, IsUIChildPickOnlyInSizeRange, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "UIPicBox @+ CreateAddMask()", asMETHODPR(BPFile, CreateAddMask, (), UIPicBox * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void SetMaskVal(int maskVal)", asMETHODPR(BPFile, SetMaskVal, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "int GetMaskVal() const", asMETHODPR(BPFile, GetMaskVal, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "UIPicBox @+ GetMask()", asMETHODPR(BPFile, GetMask, (), UIPicBox * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPFile", "void DestoryMask()", asMETHODPR(BPFile, DestoryMask, (), void), asCALL_THISCALL);
	assert(r >= 0);
	// Class: BPModule
	r = asEngine->RegisterObjectBehaviour("BPModule", asBEHAVE_FACTORY, "BPModule @+ f()", asFUNCTION(fBPModule0), asCALL_CDECL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("BPModule", asBEHAVE_ADDREF, "void f()", asMETHOD(BPModule, IncrementReferences), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectBehaviour("BPModule", asBEHAVE_RELEASE, "void f()", asMETHOD(BPModule, DecrementReferences), asCALL_THISCALL); 
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "UIFrame@+ opImplCast()", asFUNCTION((RefCast<BPModule, UIFrame>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "SizeNode@+ opImplCast()", asFUNCTION((RefCast<UIFrame, SizeNode>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Node@+ opImplCast()", asFUNCTION((RefCast<SizeNode, Node>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Movable@+ opImplCast()", asFUNCTION((RefCast<Node, Movable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Controlledable@+ opImplCast()", asFUNCTION((RefCast<Movable, Controlledable>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Object@+ opImplCast()", asFUNCTION((RefCast<Controlledable, Object>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "RefObject@+ opImplCast()", asFUNCTION((RefCast<Object, RefObject>)), asCALL_CDECL_OBJLAST);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void IncrementReferences()", asMETHODPR(BPModule, IncrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void DecrementReferences()", asMETHODPR(BPModule, DecrementReferences, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "int GetReferences() const", asMETHODPR(BPModule, GetReferences, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void Enable(bool enable)", asMETHODPR(BPModule, Enable, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsEnable() const", asMETHODPR(BPModule, IsEnable, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetActivate(bool act)", asMETHODPR(BPModule, SetActivate, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsActivated() const", asMETHODPR(BPModule, IsActivated, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const Rtti & GetRttiType() const", asMETHODPR(BPModule, GetRttiType, () const, const Rtti & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "uint16 GetRttiVersion() const", asMETHODPR(BPModule, GetRttiVersion, () const, unsigned short), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsExactly(const Rtti & type) const", asMETHODPR(BPModule, IsExactly, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsDerived(const Rtti & type) const", asMETHODPR(BPModule, IsDerived, (const Rtti & ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsExactlyTypeOf(const Object @+ object) const", asMETHODPR(BPModule, IsExactlyTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsDerivedTypeOf(const Object @+ object) const", asMETHODPR(BPModule, IsDerivedTypeOf, (const Object * ) const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetUserDataFloat(const string & name, float val)", asMETHODPR(BPModule, SetUserDataFloat, (const std::string & , float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "float GetUserDataFloat(const string & name, bool & isValied) const", asMETHODPR(BPModule, GetUserDataFloat, (const std::string & , bool * ) const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const string & GetResourcePath() const", asMETHODPR(BPModule, GetResourcePath, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetName(const string & name)", asMETHODPR(BPModule, SetName, (const std::string & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const string & GetName() const", asMETHODPR(BPModule, GetName, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Object @+ GetObjectByName(const string & name)", asMETHODPR(BPModule, GetObjectByName, (const std::string & ), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetID(int id)", asMETHODPR(BPModule, SetID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "int GetID() const", asMETHODPR(BPModule, GetID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Object @+ GetObjectByID(int id)", asMETHODPR(BPModule, GetObjectByID, (int), Object * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void ComeInEventWorld()", asMETHODPR(BPModule, ComeInEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void GoOutEventWorld()", asMETHODPR(BPModule, GoOutEventWorld, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsInEventWorld()", asMETHODPR(BPModule, IsInEventWorld, (), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void ResetPlay()", asMETHODPR(BPModule, ResetPlay, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void Play()", asMETHODPR(BPModule, Play, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsPlaying() const", asMETHODPR(BPModule, IsPlaying, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void Stop()", asMETHODPR(BPModule, Stop, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void Reset()", asMETHODPR(BPModule, Reset, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetSelfCtrled(bool selfCtrled)", asMETHODPR(BPModule, SetSelfCtrled, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsSelfCtrled() const", asMETHODPR(BPModule, IsSelfCtrled, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAutoPlay(bool autoPlay)", asMETHODPR(BPModule, SetAutoPlay, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsAutoPlay() const", asMETHODPR(BPModule, IsAutoPlay, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "int GetNumControllers() const", asMETHODPR(BPModule, GetNumControllers, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Controller @+ GetController(int i) const", asMETHODPR(BPModule, GetController, (int) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Controller @+ GetControllerByName(const string & name) const", asMETHODPR(BPModule, GetControllerByName, (const std::string & ) const, Controller * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool HasController(Controller @+ controller)", asMETHODPR(BPModule, HasController, (Controller * ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void AttachController(Controller @+ controller)", asMETHODPR(BPModule, AttachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void DetachController(Controller @+ controller)", asMETHODPR(BPModule, DetachController, (Controller * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void DetachAllControllers()", asMETHODPR(BPModule, DetachAllControllers, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SortControls()", asMETHODPR(BPModule, SortControls, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool UpdateControllers(double applicationTime, double elapsedTime)", asMETHODPR(BPModule, UpdateControllers, (double, double), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void Show(bool show)", asMETHODPR(BPModule, Show, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsShow() const", asMETHODPR(BPModule, IsShow, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "Movable @+ GetParent()", asMETHODPR(BPModule, GetParent, (), Movable * ), asCALL_THISCALL);
	assert(r >= 0);
					r = asEngine->RegisterObjectMethod("BPModule", "int GetNumChildren() const", asMETHODPR(BPModule, GetNumChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "int GetNumValidChildren() const", asMETHODPR(BPModule, GetNumValidChildren, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "int AttachChild(Movable @+ child)", asMETHODPR(BPModule, AttachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void InsertChild(Movable @+ before, Movable @+ child)", asMETHODPR(BPModule, InsertChild, (Movable * , Movable * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "int DetachChild(Movable @+ child)", asMETHODPR(BPModule, DetachChild, (Movable * ), int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool DetachChildByName(const string & name)", asMETHODPR(BPModule, DetachChildByName, (const std::string & ), bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void DetachAllChildren()", asMETHODPR(BPModule, DetachAllChildren, (), void), asCALL_THISCALL);
	assert(r >= 0);
		r = asEngine->RegisterObjectMethod("BPModule", "void SetAlpha(float alpha)", asMETHODPR(BPModule, SetAlpha, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetColor(const Float3 & color)", asMETHODPR(BPModule, SetColor, (const Float3 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetBrightness(float brightness)", asMETHODPR(BPModule, SetBrightness, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetCastShadow(bool castShadow)", asMETHODPR(BPModule, SetCastShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetReceiveShadow(bool reciveShadow)", asMETHODPR(BPModule, SetReceiveShadow, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetDoPickPriority(bool doPickPriority)", asMETHODPR(BPModule, SetDoPickPriority, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsDoPickPriority() const", asMETHODPR(BPModule, IsDoPickPriority, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void OnNotPicked(int pickInfo)", asMETHODPR(BPModule, OnNotPicked, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetNeedCalUpdateChild(bool needCal)", asMETHODPR(BPModule, SetNeedCalUpdateChild, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsNeedCalUpdateChild() const", asMETHODPR(BPModule, IsNeedCalUpdateChild, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorID(int anchorID)", asMETHODPR(BPModule, SetAnchorID, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "int GetAnchorID() const", asMETHODPR(BPModule, GetAnchorID, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetSize(float width, float height)", asMETHODPR(BPModule, SetSize, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetSize(const Sizef & size)", asMETHODPR(BPModule, SetSize, (const Sizef & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const Sizef & GetSize() const", asMETHODPR(BPModule, GetSize, () const, const Sizef & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetWidth(float width)", asMETHODPR(BPModule, SetWidth, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "float GetWidth() const", asMETHODPR(BPModule, GetWidth, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetHeight(float height)", asMETHODPR(BPModule, SetHeight, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "float GetHeight() const", asMETHODPR(BPModule, GetHeight, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetPivot(float x, float y)", asMETHODPR(BPModule, SetPivot, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetPivot(const Float2 & pvoit)", asMETHODPR(BPModule, SetPivot, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const Float2 & GetPvoit() const", asMETHODPR(BPModule, GetPvoit, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void EnableAnchorLayout(bool enable)", asMETHODPR(BPModule, EnableAnchorLayout, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsAnchorLayoutEnable() const", asMETHODPR(BPModule, IsAnchorLayoutEnable, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorHor(float anchorX, float anchorY)", asMETHODPR(BPModule, SetAnchorHor, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorHor(const Float2 & anchor)", asMETHODPR(BPModule, SetAnchorHor, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const Float2 & GetAnchorHor() const", asMETHODPR(BPModule, GetAnchorHor, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorParamHor(float param0, float param1)", asMETHODPR(BPModule, SetAnchorParamHor, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorParamHor(const Float2 & param)", asMETHODPR(BPModule, SetAnchorParamHor, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const Float2 & GetAnchorParamHor() const", asMETHODPR(BPModule, GetAnchorParamHor, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorVer(float anchorX, float anchorY)", asMETHODPR(BPModule, SetAnchorVer, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorVer(const Float2 & anchor)", asMETHODPR(BPModule, SetAnchorVer, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const Float2 & GetAnchorVer() const", asMETHODPR(BPModule, GetAnchorVer, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorParamVer(float param0, float param1)", asMETHODPR(BPModule, SetAnchorParamVer, (float, float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetAnchorParamVer(const Float2 & param)", asMETHODPR(BPModule, SetAnchorParamVer, (const Float2 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const Float2 & GetAnchorParamVer() const", asMETHODPR(BPModule, GetAnchorParamVer, () const, const Float2 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "UICanvas @+ GetBelongUICanvas()", asMETHODPR(BPModule, GetBelongUICanvas, (), UICanvas * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "UIPicBox @+ CreateAddBackgroundPicBox(bool setWhite)", asMETHODPR(BPModule, CreateAddBackgroundPicBox, (bool), UIPicBox * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "UIPicBox @+ GetBackgroundPicBox()", asMETHODPR(BPModule, GetBackgroundPicBox, (), UIPicBox * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void DestoryBackgroundPicBox()", asMETHODPR(BPModule, DestoryBackgroundPicBox, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetActivateColor(const Float3 & color)", asMETHODPR(BPModule, SetActivateColor, (const Float3 & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "const Float3 & GetActivateColor() const", asMETHODPR(BPModule, GetActivateColor, () const, const Float3 & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetActivateAlpha(float alpha)", asMETHODPR(BPModule, SetActivateAlpha, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "float GetActivateAlpha() const", asMETHODPR(BPModule, GetActivateAlpha, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetActivateBrightness(float brightness)", asMETHODPR(BPModule, SetActivateBrightness, (float), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "float GetActivateBrightness() const", asMETHODPR(BPModule, GetActivateBrightness, () const, float), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetUIChildPickOnlyInSizeRange(bool onlyInRange)", asMETHODPR(BPModule, SetUIChildPickOnlyInSizeRange, (bool), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "bool IsUIChildPickOnlyInSizeRange() const", asMETHODPR(BPModule, IsUIChildPickOnlyInSizeRange, () const, bool), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "UIPicBox @+ CreateAddMask()", asMETHODPR(BPModule, CreateAddMask, (), UIPicBox * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void SetMaskVal(int maskVal)", asMETHODPR(BPModule, SetMaskVal, (int), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "int GetMaskVal() const", asMETHODPR(BPModule, GetMaskVal, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "UIPicBox @+ GetMask()", asMETHODPR(BPModule, GetMask, (), UIPicBox * ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("BPModule", "void DestoryMask()", asMETHODPR(BPModule, DestoryMask, (), void), asCALL_THISCALL);
	assert(r >= 0);
	// Class: BPManager
	// Class: ScriptHandler
	r = asEngine->RegisterObjectMethod("ScriptHandler", "void AddCall(const string & callStr)", asMETHODPR(ScriptHandler, AddCall, (const std::string & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ScriptHandler", "int GetNumCalls() const", asMETHODPR(ScriptHandler, GetNumCalls, () const, int), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ScriptHandler", "const string & GetCall(int i) const", asMETHODPR(ScriptHandler, GetCall, (int) const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ScriptHandler", "void RemoveCall(const string & callStr)", asMETHODPR(ScriptHandler, RemoveCall, (const std::string & ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ScriptHandler", "void RemoveAllCalls()", asMETHODPR(ScriptHandler, RemoveAllCalls, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ScriptHandler", "void Call()", asMETHODPR(ScriptHandler, Call, (), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("ScriptHandler", "const string & GetCareStr() const", asMETHODPR(ScriptHandler, GetCareStr, () const, const std::string & ), asCALL_THISCALL);
	assert(r >= 0);
	// Class: General_EventHandler
	r = asEngine->RegisterObjectMethod("General_EventHandler", "void AddScriptHandler(ScriptHandler @ handler)", asMETHODPR(General_EventHandler, AddScriptHandler, (ScriptHandler * ), void), asCALL_THISCALL);
	assert(r >= 0);
	r = asEngine->RegisterObjectMethod("General_EventHandler", "void RemoveAllHandlers()", asMETHODPR(General_EventHandler, RemoveAllHandlers, (), void), asCALL_THISCALL);
	assert(r >= 0);
	// Class: Edit
