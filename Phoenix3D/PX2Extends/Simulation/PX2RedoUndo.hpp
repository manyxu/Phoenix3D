...
namespace PX2
{
	...
	class PX2_EXTENDS_ITEM MovableTransURDo : public URDo
	{
	public:
		MovableTransURDo();
	...
	class PX2_EXTENDS_ITEM ObjectAddDeleteURDo : public URDo
	{
	public:
	...
	class PX2_EXTENDS_ITEM URDoManager : public Singleton<URDoManager>
	{
	public:
		URDoManager();
		~URDoManager();
