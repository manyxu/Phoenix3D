...
//----------------------------------------------------------------------------
void UIProgressBar::SetPivot(const Float2 &anchorPoint)
{
...
{
	float posX = -mSize.Width * mPivotPoint[0];
...
void UIProgressBar::RegistProperties()
{
	...
	AddProperty("AnchorPoint", PT_FLOAT2, mPivotPoint);
