...
namespace PX2
{
	...
	class PX2_EXTENDS_ITEM UIPropertyGrid : public UITree
	{
		PX2_DECLARE_RTTI;
		PX2_DECLARE_NAMES;
	...
	public:
		...
		UIPropertyItem *AddItemType(UIItem *parentItem, 
			...
			const std::string &name, const Any &data, Object *obj = 0);
	...
	typedef PointerRef<UIPropertyGrid> UIPropertyGridPtr;
