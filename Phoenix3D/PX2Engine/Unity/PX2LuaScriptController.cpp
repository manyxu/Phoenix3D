	...
	const std::string &className)
{
	...
	{
		LuaPlus::LuaObject metaTableObj = mLuaState->GetGlobals().Lookup(LuaSCRIPCONTROLLER_NAME);
		assertion(!metaTableObj.IsNil(), "");
	...
	LuaPlus::LuaObject &constructionData)
{
	...
	{
		PX2_LOG_INFO("scriptClass is not a table in LuaScriptController::BuildCppDataFromScript()");
		return false;
	}
