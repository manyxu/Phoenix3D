...
namespace PX2
{
	...
	public:
		...
		void SetDrawSetViewPort(bool setViewPort);
		bool IsDrawSetViewPort() const;
	...
	public:
		...
		void SetPickedSomething(bool picked);
		bool IsPickedSomething() const;
