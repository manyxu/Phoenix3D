...
//----------------------------------------------------------------------------
void UITabFrame::OnWidgetPicked(const UIInputData &inputData)
{
...
//----------------------------------------------------------------------------
void UITabFrame::OnWidgetNotPicked(const UIInputData &inputData)
{
...
{
	UIAuiManager::GetSingleton().RemoveTabContentFrame(name);
