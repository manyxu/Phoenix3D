...
//----------------------------------------------------------------------------
void UIFrame::OnWidgetNotPicked(const UIInputData &inputData)
{
	PX2_UNUSED(inputData);
}
//----------------------------------------------------------------------------
void UIFrame::OnWidgetPicked(const UIInputData &inputData)
{
	PX2_UNUSED(inputData);
}
//----------------------------------------------------------------------------
...
void UIFrame::Load(InStream& source)
{
	...
	source.ReadBool(mIsUIChildPickOnlyInSizeRange);
...
void UIFrame::Save(OutStream& target) const
{
	...
	target.WriteBool(mIsUIChildPickOnlyInSizeRange);
...
int UIFrame::GetStreamingSize(Stream &stream) const
{
	...
	size += PX2_BOOLSIZE(mIsUIChildPickOnlyInSizeRange);
