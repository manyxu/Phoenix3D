...
namespace PX2
{
	...
	struct PX2_FOUNDATION_ITEM SoundSystemInitInfo
	{
		SoundSystemInitInfo();
	...
	struct PX2_FOUNDATION_ITEM SoundCreateInfo3D
	{
		SoundCreateInfo3D();
	...
	class PX2_FOUNDATION_ITEM SoundSystem : public Singleton<SoundSystem>
	{
	public:
		virtual ~SoundSystem();
