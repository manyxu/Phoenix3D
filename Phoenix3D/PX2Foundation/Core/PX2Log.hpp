...
namespace PX2
{
	...
	class PX2_FOUNDATION_ITEM LogBuffer : public FixMemoryObject<LogBuffer>
	{
	public:
	...
	class PX2_FOUNDATION_ITEM LogHandler
	{
	public:
	...
	class PX2_FOUNDATION_ITEM Logger : public ThreadServer, public Singleton<Logger>
	{
	public:
		Logger ();
		virtual ~Logger ();
