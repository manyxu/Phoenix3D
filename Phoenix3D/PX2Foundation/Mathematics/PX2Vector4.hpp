...
namespace PX2
{
	...
	public:
		...
		// 特定值
		PX2_FOUNDATION_ITEM static const Vector4 ZERO;
		PX2_FOUNDATION_ITEM static const Vector4 UNIT_X;  //< (1,0,0,0)
		PX2_FOUNDATION_ITEM static const Vector4 UNIT_Y;  //< (0,1,0,0)
		PX2_FOUNDATION_ITEM static const Vector4 UNIT_Z;  //< (0,0,1,0)
		PX2_FOUNDATION_ITEM static const Vector4 UNIT_W;  //< (0,0,0,1)
		PX2_FOUNDATION_ITEM static const Vector4 UNIT;     //< (1,1,1,1)
