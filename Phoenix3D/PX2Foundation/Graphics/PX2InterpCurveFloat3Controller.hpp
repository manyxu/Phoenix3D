...
namespace PX2
{
	...
	class PX2_FOUNDATION_ITEM InterpCurveFloat3Controller : public InterpCurveController
	{
		PX2_DECLARE_RTTI;
		PX2_DECLARE_NAMES;
...
#include "PX2InterpCurveFloat3Controller.inl"
	...
	typedef PointerRef<InterpCurveFloat3Controller> InterpCurveFloat3ControllerPtr;
