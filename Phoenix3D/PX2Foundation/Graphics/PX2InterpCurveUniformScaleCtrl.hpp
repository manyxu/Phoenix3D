...
namespace PX2
{
	...
	class PX2_FOUNDATION_ITEM InterpCurveUniformScaleController : public InterpCurveFloatController
	{
		PX2_DECLARE_RTTI;
		PX2_DECLARE_NAMES;
	...
	typedef PointerRef<InterpCurveUniformScaleController> InterpCurveUniformScaleControllerPtr;
