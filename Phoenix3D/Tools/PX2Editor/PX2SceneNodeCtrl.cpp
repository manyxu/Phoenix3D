...
//----------------------------------------------------------------------------
void SceneNodeCtrl::OnLeftUp(Camera *camera, const APoint &pos,
	const Sizef &size)
{
	SetDragType(DT_NONE);
}
	...
	APoint posNow, APoint posBefore, const Sizef &size)
{
	...
	else if (CT_ROLATE == mCtrlType)
	{
		...
		degree2Radius[0] = degree2Radius[0] * Mathf::DEG_TO_RAD;
		degree2Radius[1] = degree2Radius[1] * Mathf::DEG_TO_RAD;
		degree2Radius[2] = degree2Radius[2] * Mathf::DEG_TO_RAD;
