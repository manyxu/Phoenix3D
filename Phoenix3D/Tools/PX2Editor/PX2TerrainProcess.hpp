...
namespace PX2
{
	...
	class PX2_EDITOR_ITEM TerrainProcess
	{
	public:
		~TerrainProcess();
	...
	class PX2_EDITOR_ITEM TerrainHeightProcess : public TerrainProcess
	{
	public:
	...
	class PX2_EDITOR_ITEM TerrainTextureProcess : public TerrainProcess
	{
	public:
	...
	class PX2_EDITOR_ITEM TerrainJunglerProcess : public TerrainProcess
	{
	public:
